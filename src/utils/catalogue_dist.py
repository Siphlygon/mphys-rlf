...
class CatalogueDistribution:
    ...
    def __init__(self,
        ...
        self.catalogue = HardcastleCatalogue()
...
class RMSDistribution(CatalogueDistribution):
    ...
    def __init__(self, bin_num: int = 100):
        ...
        Args:
            bin_num (int, optional): The number of bins for the histogram. Defaults to 100.
            value_name (str, optional): The name of the value being analyzed. Defaults to "RMS".
            units (str, optional): The units of the value being analyzed. Defaults to "mJy/beam".
        """
        ...
        super().__init__("RMSDistribution", bin_num, "RMS", "mJy/beam")
...
class LASDistribution(CatalogueDistribution):
    ...
    def __init__(self, bin_num: int = 100):
        ...
        super().__init__("LASDistribution", bin_num, "LAS", "arcseconds")
...
class PeakFluxDistribution(CatalogueDistribution):
    ...
    def __init__(self, bin_num: int = 100):
        ...
        super().__init__("PeakFluxDistribution", bin_num, "Peak Flux", "mJy/beam")
